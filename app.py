# app.py — FULL VERSION
# - Accounts read live from Google Sheets (gspread)
# - /profile page (name, email, role)
# - /explore handles POST to add-to-cart (no /add_to_cart route)
# - Parquet-backed images
# - Search threshold 0.4 + substring fallback
# - /cart page uses cart.htm
...
# Accounts DB (Google Sheets)
# -----------------------------
GOOGLE_SA_JSON = "savr-accounts-database-acf690225a0e.json"
